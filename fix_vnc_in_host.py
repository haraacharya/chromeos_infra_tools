...
if __name__ == "__main__":
    ...
    tmux_vnc_command = 'tmux new-session -d -s vnc "x11vnc --forever --shared --noxrecord --ncache_cr"'
    tmux_vnc_command_with_display_1 = 'tmux new-session -d -s vnc "x11vnc --forever -display :1 --shared --noxrecord --ncache_cr"'
